 ...
 * This is not mandatory but highly suggested so that {com.birbit.android.jobqueue.JobManager} can avoid
...
public interface NetworkEventProvider {
    ...
    interface Listener {
        /**
         * @param networkStatus {@ com.birbit.android.jobqueue.network.NetworkUtil.NetworkStatus}
         */
