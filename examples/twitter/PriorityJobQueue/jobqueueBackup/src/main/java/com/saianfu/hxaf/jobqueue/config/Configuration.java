package com.saianfu.hxaf.jobqueue.config;

import android.content.Context;
import android.net.ConnectivityManager;
import androidx.annotation.NonNull;
import androidx.annotation.Nullable;
import com.saianfu.hxaf.jobqueue.DefaultQueueFactory;
import com.saianfu.hxaf.jobqueue.JobQueue;
import com.saianfu.hxaf.jobqueue.QueueFactory;
import com.saianfu.hxaf.jobqueue.di.DependencyInjector;
import com.saianfu.hxaf.jobqueue.log.CustomLogger;
import com.saianfu.hxaf.jobqueue.log.JqLog;
import com.saianfu.hxaf.jobqueue.network.NetworkUtil;
import com.saianfu.hxaf.jobqueue.network.NetworkUtilImpl;
import com.saianfu.hxaf.jobqueue.persistentQueue.sqlite.SqliteJobQueue;
import com.saianfu.hxaf.jobqueue.scheduling.Scheduler;
import com.saianfu.hxaf.jobqueue.timer.SystemTimer;
import com.saianfu.hxaf.jobqueue.timer.Timer;

import java.util.concurrent.ThreadFactory;
import java.util.regex.Pattern;

/**
 * { com.birbit.android.jobqueue.JobManager} configuration object
 */
...
public class Configuration {
    ...
    public static final class Builder {
         ...
         * {com.birbit.android.jobqueue.inMemoryQueue.SimpleInMemoryPriorityQueue}
         ...
         * { com.birbit.android.jobqueue.persistentQueue.sqlite.SqliteJobQueue.JavaSerializer}
         ...
         * { com.birbit.android.jobqueue.BatchingScheduler#DEFAULT_BATCHING_PERIOD_IN_MS} delay.
