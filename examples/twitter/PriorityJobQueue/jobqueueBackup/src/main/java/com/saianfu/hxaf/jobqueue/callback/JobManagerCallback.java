package com.saianfu.hxaf.jobqueue.callback;
...
public interface JobManagerCallback {
     ...
     * { com.birbit.android.jobqueue.JobManager#cancelJobs(TagConstraint, String...)} while it was running.
     *
     *  com.birbit.android.jobqueue.JobManager#cancelJobs(TagConstraint, String...)
     *  com.birbit.android.jobqueue.JobManager#cancelJobsInBackground(CancelResult.AsyncCancelCallback, TagConstraint, String...)
     */
     ...
     *                         { com.birbit.android.jobqueue.JobManager#cancelJobs(TagConstraint, String...)} request.
