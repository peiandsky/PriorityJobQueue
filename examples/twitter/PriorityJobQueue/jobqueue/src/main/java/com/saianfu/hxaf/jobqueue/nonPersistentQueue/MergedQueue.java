package com.saianfu.hxaf.jobqueue.nonPersistentQueue;
...
abstract public class MergedQueue implements JobSet {
    ...
    /**
     *
     * @param initialCapacity passed to {MergedQueue#createQueue(com.path.android.jobqueue.nonPersistentQueue.MergedQueue.SetId, int, Comparator)}
     * @param comparator passed to {MergedQueue#createQueue(com.path.android.jobqueue.nonPersistentQueue.MergedQueue.SetId, int, Comparator)}
