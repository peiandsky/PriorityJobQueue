...
abstract public class BaseJob implements Serializable {
    ...
    /**
     * before each run, JobManager sets this number. Might be useful for the { com.path.android.jobqueue.BaseJob#onRun()}
     * method
     * @return
     */
    ...
    /**
     * if job is set to require network, it will not be called unless { com.path.android.jobqueue.network.NetworkUtil}
