...
import com.saianfu.hxaf.jobqueue.nonPersistentQueue.NonPersistentPriorityQueue;
import com.saianfu.hxaf.jobqueue.persistentQueue.sqlite.SqliteJobQueue;

/**
 * { com.path.android.jobqueue.JobManager} configuration object
 */
public class Configuration {
    ...
    public static final class Builder {
         ...
         * By default, it will use { SqliteJobQueue} and { NonPersistentPriorityQueue}
         ...
         * by default, it uses a { SqliteJobQueue.JavaSerializer} which will use default Java serialization.
         *  JobSerializer2
         * @return
         */
